...
type User struct {
	...
	Wallet     int32  `gorm:"column:wallet;type:int(11);not null" json:"wallet"` // 账户余额
	Avatar     string `gorm:"column:avatar;type:varchar(255);not null" json:"avatar"`
	Gender     int    `gorm:"column:gender;type:tinyint(4);not null" json:"gender"` // 性别 0：未知、1：男、2：女
	...
	SessionKey string `gorm:"column:session_key;type:char(64);not null" json:"session_key"`
