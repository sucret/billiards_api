...
func newCoupon(db *gorm.DB) coupon {
	_coupon := coupon{}

	_coupon.couponDo.UseDB(db)
	...
	_coupon.Price = field.NewInt32(tableName, "price")
	_coupon.ShopID = field.NewInt32(tableName, "shop_id")
	_coupon.Type = field.NewInt(tableName, "type")
	_coupon.Duration = field.NewInt32(tableName, "duration")
	_coupon.TableType = field.NewInt(tableName, "table_type")
...
type coupon struct {
	...
	ShopID    field.Int32
	Type      field.Int   // 优惠券类型，1｜抵时卡
	Duration  field.Int32 // 抵时长，分钟
	TableType field.Int   // 类型，1｜通用，2｜球桌，3｜棋牌桌
...
func (c *coupon) updateTableName(table string) *coupon {
	...
	c.ShopID = field.NewInt32(table, "shop_id")
	c.Type = field.NewInt(table, "type")
	c.Duration = field.NewInt32(table, "duration")
	c.TableType = field.NewInt(table, "table_type")
...
func (c *coupon) fillFieldMap() {
	...
	c.fieldMap["shop_id"] = c.ShopID
	c.fieldMap["type"] = c.Type
	c.fieldMap["duration"] = c.Duration
	c.fieldMap["table_type"] = c.TableType
}
